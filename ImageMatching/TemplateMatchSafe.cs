...
{
    public class TemplateMatchSafe
    {
        /// <summary>
        ...
        /// <returns></returns>
        public bool IsMatch(Mat matSource, Mat matTarget, double holdLine)
        {
        ...
        /// <returns></returns>
        public bool IsMatch(Mat matSource, Mat matTarget, double holdLine, TemplateMatchModes mode)
        {
        ...
        /// <param name="matTarget">探す行列</param>
        /// <returns>類似度</returns>
        public double Match(Mat matSource, Mat matTarget)
        {
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns>類似度</returns>
        public double Match(Mat matSource, Mat matTarget, TemplateMatchModes mode)
        {
            Mat matBuffer = new Mat();
        ...
        /// 使用する場面によるが0.7～0.9くらいが妥当？</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat matTarget, double holdLine)
        {
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat matTarget, double holdLine, TemplateMatchModes mode)
        {
            Mat matBuffer = new Mat();
        ...
        /// 使用する場面によるが0.7～0.9くらいが妥当？</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat[] matTargets, double holdLine)
        {
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat[] matTargets, double holdLine, TemplateMatchModes mode)
        {
        ...
        /// 使用する場面によるが0.7～0.9くらいが妥当？</param>
        /// <returns></returns>
        public List<Rect> Matches(Mat matSource, Mat matTarget, double holdLine)
        {
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public List<Rect> Matches(Mat matSource, Mat matTarget, double holdLine, TemplateMatchModes mode)
        {
