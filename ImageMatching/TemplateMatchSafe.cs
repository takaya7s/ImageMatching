...
namespace ImageMatching
{
    public class TemplateMatchSafe
    {
        ...
        /// <returns></returns>
        public bool IsMatch(Mat matSource, Mat matTarget, double holdLine = 0.9
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat matTarget, double holdLine = 0.9
            , TemplateMatchModes mode = TemplateMatchModes.CCoeffNormed)
        {
            Mat matBuffer = new Mat();
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public Rect Match(Mat matSource, Mat[] matTargets, double holdLine = 0.9
            , TemplateMatchModes mode = TemplateMatchModes.CCoeffNormed)
        {
        ...
        /// <param name="mode">TemplateMatchModes</param>
        /// <returns></returns>
        public List<Rect> Matches(Mat matSource, Mat matTarget, double holdLine = 0.9
            , TemplateMatchModes mode = TemplateMatchModes.CCoeffNormed)
        {
